...
/===================================================== */
  ...
  function wpseed_enqueue_scripts_and_styles() {
    ...
    wp_register_script('jquery', get_template_directory_uri() . '/dist/scripts/jquery.min.js', false, '2.1.4');
...
/===================================================== */
  ...
  // Load theme textdomain (based on locale en_GB)
